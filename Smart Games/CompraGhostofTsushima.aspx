<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraGhostofTsushima.aspx.cs" Inherits="Smart_Games.CompraGhostofTsushima" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Ghost Of Tsushima PS4</title>
     <style type="text/css">
...
<div id="Produto">PRODUTO</div>
        ...
        <div id="FotoProduto"><img src="https://live.staticflickr.com/65535/49210891223_9ba2f131af_o.png" width="100" height="100" /></div>
        <div id="NomeProduto">Ghost Of Tsushima - PS4</div>
        <div id="PrecoProduto">R$ 249,00</div>
        <div id="PrecoSubTotal">R$ 249,00</div>
