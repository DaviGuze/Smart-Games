<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoBatmanXBox360.aspx.cs" Inherits="Smart_Games.DescricaoBatmanXBox360" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Batman Arkham City XBox 360</title>
    <style type="text/css">
...
Resolução: Até 1080p
        ...
        <div id="FormaDePagamento">Jogo Batman Arkham City - XBox 360<br /><br />
            R$ 31,00<br />
            até 12x de R$ 2,58 sem juros 
        </div>

        <div id="comprar"><a href="CompraBatmanXBox360.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
