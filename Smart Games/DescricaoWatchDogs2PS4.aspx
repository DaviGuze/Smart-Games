<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoWatchDogs2PS4.aspx.cs" Inherits="Smart_Games.DescricaoWatchDogs2PS4" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        <div id="logo"><img src="https://www.bhgames.com.br/imagem/index/15094616/G/wd2_buy_ps4_3d_rated_297x420_desktop_254727.png" width="450" height="500"/></div>
...
Resolução: Até 1080p 
        ...
        <div id="FormaDePagamento">Jogo Watch Dogs 2 - PS4<br /><br />
            R$ 60,00<br />
            até 12x de R$ 5,00 sem juros 
        </div>

        <div id="comprar"><a href="CompraWatchDogs2PS4.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
