<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoOverWatchNintendoSwitch.aspx.cs" Inherits="Smart_Games.DescricaoOverWatchNintendoSwitch" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="logo"><img src="https://gp1blizzard.blob.core.windows.net/propressroom/Content/Artwork/Eva/BlizzardLive/artwork/2019/08/30215604-4df0a654-7d7f-4be9-9219-f11c9c83a844/OW_SWITCH_INLAY_3D_RIGHT_AR.png?lightbox=y&ex=2021-03-01+03%3A00%3A00&sky=7d816a66ae6b47210584a969d8951f91c1dcb9234ed4af2ea67730b605b5c59b" width="450" height="500"/></div>
...
Resolução: Até 1080p  
        ...
        <div id="FormaDePagamento">OverWatch Legendary Edition - Nintendo Switch<br /><br />
            R$ 160,00<br />
            até 12x de R$ 13,33 sem juros 
        </div>

        <div id="comprar"><a href="compraOverWatchNintendoSwitch.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
