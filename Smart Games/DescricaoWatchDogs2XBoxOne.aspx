<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoWatchDogs2XBoxOne.aspx.cs" Inherits="Smart_Games.DescricaoWatchDogsXBoxOne" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Watch Dogs 2 XBox One</title>
...
<body style="background-color:black">
    <form id="form1" runat="server">
          ...
          <div id="logo"><img src="https://mrkumagai.com.br/wp-content/uploads/2020/11/watch-dogs-2-x1-capa-320x320.png" width="450" height="500"/></div>
...
Resolução: Até 1080p 
        ...
        <div id="FormaDePagamento">Jogo Watch Dogs 2 - XBox One<br /><br />
            R$ 60,00<br />
            até 12x de R$ 5,00 sem juros 
        </div>

        <div id="comprar"><a href="CompraWatchDogs2XBoxOne.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
