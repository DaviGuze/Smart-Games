<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraSpiderMan.aspx.cs" Inherits="Smart_Games.CompraSpiderMan" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="FotoProduto"><img src="http://lojasaraiva.vteximg.com.br/arquivos/ids/12116535/1008332884.jpg?v=637142275667700000" width="100" height="100" /></div>
        <div id="NomeProduto">Spider Man - PS4</div>
        <div id="PrecoProduto">R$ 116,90</div>
        <div id="PrecoSubTotal">R$ 116,90</div>
