<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraGodOfWar3PS3.aspx.cs" Inherits="Smart_Games.CompraGodOfWar3PS3" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="FotoProduto"><img src="https://jogorama.com.br/arquivos/noticias/2545_1.jpg" width="100" height="100" /></div>
        <div id="NomeProduto">God of War 3 - PS3</div>
        <div id="PrecoProduto">R$ 69,90</div>
        <div id="PrecoSubTotal">R$ 69,90</div>
