<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraWatchDogs2XBoxOne.aspx.cs" Inherits="Smart_Games.CompraWatchDogs2XBoxOne" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="FotoProduto"><img src="https://mrkumagai.com.br/wp-content/uploads/2020/11/watch-dogs-2-x1-capa-320x320.png" width="100" height="100" /></div>
        <div id="NomeProduto">Watch Dogs 2 XBoxOne</div>
        <div id="PrecoProduto">R$ 60,00</div>
        <div id="PrecoSubTotal">R$ 60,00</div>
