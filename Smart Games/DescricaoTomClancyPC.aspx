<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoTomClancyPC.aspx.cs" Inherits="Smart_Games.DescricaoTomClancyPC" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Tom Clancy'S Splinter Cell Double Agent PC</title>
    <style type="text/css">
...
<body style="background-color:black">
    <form id="form1" runat="server">
         ...
         <div id="logo"><img src="https://www.gamingdragons.com/images/game_img/splinterdouble.jpg" width="450" height="500"/></div>
...
Resolução: Até 720p
        ...
        <div id="FormaDePagamento">Jogo Tom Clancy'S Splinter Cell Double Agent PC<br /><br />
            R$ 36,00<br />
            até 12x de R$ 3,00 sem juros 
        </div>

        <div id="comprar"><a href="CompraTomClancyPC.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
