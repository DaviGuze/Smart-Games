<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraGodOfWar3PS4.aspx.cs" Inherits="Smart_Games.CompraGodOfWar3PS4" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="FotoProduto"><img src="https://www.pharaohshop.com.br/imagesProd/PS4-God-of-War-3-Remastered-7025.png" width="100" height="100" /></div>
        <div id="NomeProduto">God of War 3 - PS4</div>
        <div id="PrecoProduto">R$ 50,00</div>
        <div id="PrecoSubTotal">R$ 50,00</div>
