<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoTomClancyPS2.aspx.cs" Inherits="Smart_Games.DescricaoTomClancyPS2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Tom Clancy'S Splinter Cell Double Agent PS2</title>
     <style type="text/css">
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="logo"><img src="https://i0.wp.com/www.outlaws8bitandbeyond.com/wp-content/uploads/2018/07/Splinter_Cell_Double_Front.png?fit=1000%2C1000&ssl=1" width="450" height="500"/></div>
...
Resolução: Até 720p
        ...
        <div id="FormaDePagamento">Jogo Tom Clancy'S Splinter Cell Double Agent PS2<br /><br />
            R$ 36,00<br />
            até 12x de R$ 3,00 sem juros 
        </div>

        <div id="comprar"><a href="CompraTomClancyPS2.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
