<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoTomClancyPS3.aspx.cs" Inherits="Smart_Games.DescricaoTomClancyPS3" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="logo"><img src="https://www.vendanovagames.com.br/wp-content/uploads/2020/07/SPLINTER-CELL-DOUBLE-AGENT.png" width="450" height="500"/></div>
...
Resolução: Até 720p
        ...
        <div id="FormaDePagamento">Jogo Tom Clancy'S Splinter Cell Double Agent PS3<br /><br />
            R$ 36,00<br />
            até 12x de R$ 3,00 sem juros 
        </div>

        <div id="comprar"><a href="CompraTomClancyPS3.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
