<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescriçãoOverWatchPS4.aspx.cs" Inherits="Smart_Games.DescriçãoLogo1" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="logo"><img src="http://lojasaraiva.vteximg.com.br/arquivos/ids/2640799/1003303408.jpg?v=637020369192400000" width="450" height="500"/></div>
...
Resolução: Até 1080p  
        ...
        <div id="FormaDePagamento">Jogo OverWatch: Origins Edition - PS4<br /><br />
            R$ 160,00<br />
            até 12x de R$ 13,33 sem juros 
        </div>

        <div id="comprar"><a href="compraOverWatchPS4.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
