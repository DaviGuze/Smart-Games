<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraTomClancyPS2.aspx.cs" Inherits="Smart_Games.CompraTomClancyPS2" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
      ...
      <div id="PrecoUnitario">PREÇO UNITARIO</div>
        ...
        <div id="FotoProduto"><img src="https://i0.wp.com/www.outlaws8bitandbeyond.com/wp-content/uploads/2018/07/Splinter_Cell_Double_Front.png?fit=1000%2C1000&ssl=1" width="100" height="100" /></div>
        <div id="NomeProduto">Tom Clancy's Splinter Cell Double Agent - PS2</div>
