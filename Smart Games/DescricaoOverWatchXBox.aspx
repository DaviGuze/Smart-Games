<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoOverWatchXBox.aspx.cs" Inherits="Smart_Games.DescricaoOverWatchXBox" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Over Watch XBox One</title>
    <style type="text/css">
...
<body style="background-color:black">
    <form id="form1" runat="server">
        ...
        <div id="logo"><img src="http://lojasaraiva.vteximg.com.br/arquivos/ids/12110467/1004281880.jpg?v=637142253278970000" width="450" height="500"/></div>
...
Resolução: Até 1080p  
        ...
        <div id="FormaDePagamento">Jogo OverWatch: Origins Edition - XBox One<br /><br />
            R$ 160,00<br />
            até 12x de R$ 13,33 sem juros 
        </div>

        <div id="comprar"><a href="compraOverWatchXBox.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
