<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraTomClancyXBox.aspx.cs" Inherits="Smart_Games.CompraTomClancyXBox" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
      ...
      <div id="PrecoUnitario">PREÇO UNITARIO</div>
        ...
        <div id="FotoProduto"><img src="https://store-images.s-microsoft.com/image/apps.52131.71716505436254393.14e11e8b-7988-40b0-b865-c14415471c60.1b507b7d-e917-4633-9bf1-1ce21c97c34d?mode=scale&q=90&h=225&w=150" width="100" height="100" /></div>
        <div id="NomeProduto">Tom Clancy's Splinter Cell Double Agent - XBox</div>
