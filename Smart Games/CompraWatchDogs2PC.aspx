<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraWatchDogs2PC.aspx.cs" Inherits="Smart_Games.CompraWatchDogs2PC" %>
...
<body style="background-color:black">
    <form id="form1" runat="server">
       ...
       <div id="PrecoUnitario">PREÇO UNITARIO</div>
        ...
        <div id="FotoProduto"><img src="https://upload.wikimedia.org/wikipedia/pt/f/f8/Watch_Dogs_2_cover.png" width="100" height="100" /></div>
        <div id="NomeProduto">Watch Dogs 2 PC</div>
