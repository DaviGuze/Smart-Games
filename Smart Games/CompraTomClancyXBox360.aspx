<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompraTomClancyXBox360.aspx.cs" Inherits="Smart_Games.CompraTomClancyXBox360" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Tom Clancy'S Splinter Cell Double Agent XBox 360</title>
    <style type="text/css">
...
<body style="background-color:black">
    ...
    <div id="PrecoUnitario">PREÇO UNITARIO</div>
        ...
        <div id="FotoProduto"><img src="https://images-na.ssl-images-amazon.com/images/I/51ZlJtGlJeL._AC_SY445_.jpg" width="100" height="100" /></div>
        <div id="NomeProduto">Tom Clancy's Splinter Cell Double Agent - XBox 360</div>
