<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescricaoGodOfWar3PS3.aspx.cs" Inherits="Smart_Games.DescricaoGodOfWar3" %>
...
Resolução: Até 1080p
        ...
        <div id="FormaDePagamento">Jogo God of War 3 - PS3<br /><br />
            R$ 50,00<br />
            até 12x de R$ 4,16 sem juros 
        </div>

        <div id="comprar"><a href="CompraGodOfWar3PS3.aspx" target="_self"><img src="https://misericordia.org.br/site/wp-content/uploads/2015/02/Botao-Comprar.jpg" width="350" height="120" /></a></div>
